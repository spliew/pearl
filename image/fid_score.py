...
Except function calculate_fid_given_data(), all the other functions are from https://github.com/abdulfatir/gan-metrics-pytorch
"""
import os
import pathlib
...
def calculate_fid_given_data(rec_imgs, real_imgs, batch_size, cuda, dims, bootstrap=True, n_bootstraps=10, model_type='inception'):
    """Calculates the FID of two paths"""
